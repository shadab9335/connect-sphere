...
function DiscoverScreen({ myInterests, setMyInterests }) {
    ...
    // Match the same personalisation pattern used for the tag bar in FeedScreen
    // (see buildFeedTabs there): All -> user's own interests, in the order they
    // picked them -> everything else. myInterests is an array of interest name
    // strings (e.g. ["Cricket", "Badminton", "Gaming", "Movies"]), same shape
    // App.js/FeedScreen already use — so no backend/shape changes needed here.
