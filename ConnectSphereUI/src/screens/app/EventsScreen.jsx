...
const EVENT_COLOR =
  "linear-gradient(135deg, rgb(191 82 127), rgb(28 17 193 / 80%))";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Plan activities with colleagues nearby 📍
        </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 2px 14px rgba(108,99,255,0.06)",
                }}
              >
                <div
                  style={{
      ...
      {leaveConfirmEvent && (
        <div
          onClick={() => setLeaveConfirmEvent(null)}
          style={{
            position: "absolute",
            inset: 0,
        ...
        >
          ...
          >
            ...
            >
              ...
              <strong>{leaveConfirmEvent.title}</strong>? You can rejoin later
                  ...
                  >
                    {EMOJIS.map((em) => (
                      <span
                        ...
                        style={{ fontSize: 22, cursor: "pointer", padding: 2 }}
                      >
                        {em}
                      </span>
                    ))}
    ...
    />
            ...
            >
              ...
              <MobileTimePicker
                value={time ? dayjs(`2026-01-01T${time}`) : null}
                onChange={(newValue) =>
                  setTime(newValue ? newValue.format("HH:mm") : "")
                }
                slotProps={{
                  textField: {
                    fullWidth: true,
              ...
              {INTERESTS.map((i) => {
                ...
                return (
                  <span
                    key={i.id}
                    onClick={() =>
                      setSelectedInterest(isSelected ? "" : i.label)
                    }
                    style={{
                      padding: "5px 12px",
                      borderRadius: 20,
